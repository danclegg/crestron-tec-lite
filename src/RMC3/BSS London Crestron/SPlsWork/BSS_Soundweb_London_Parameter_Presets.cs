...
namespace UserModule_BSS_SOUNDWEB_LONDON_PARAMETER_PRESETS
{
    public class UserModuleClass_BSS_SOUNDWEB_LONDON_PARAMETER_PRESETS : SplusObject
    {
        static CCriticalSection g_criticalSection = new CCriticalSection();
        
        
        
        Crestron.Logos.SplusObjects.DigitalInput RECALLPRESET__DOLLAR___0;
        ...
        object RECALLPRESET__DOLLAR___0_OnPush_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                MakeString ( _SplusNVRAM.COMMAND , "\u008C{0}", ITOSTRING (  __context__ , (ushort)( 0 ), (ushort)( 4 )) ) ; 
    ...
    object RECALLPRESET__DOLLAR___OnPush_1 ( Object __EventInfo__ )
...
public UserModuleClass_BSS_SOUNDWEB_LONDON_PARAMETER_PRESETS ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}




const uint RECALLPRESET__DOLLAR___0__DigitalInput__ = 0;
const uint RECALLPRESET__DOLLAR____DigitalInput__ = 1;
